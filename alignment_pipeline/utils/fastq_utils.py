        ...
        if os.path.exists(paired_path1) and os.path.exists(paired_path2):
            ...
            try:
                ...
                if size1 > 1000 and size2 > 1000:  # At least 1KB each
                    logger.info(f"Paired-end files ready for {srr}: {size1/1024/1024:.1f}MB + {size2/1024/1024:.1f}MB")
                    return True
                else:
                    logger.debug(f"Paired-end files exist but seem small for {srr}, waiting...")
