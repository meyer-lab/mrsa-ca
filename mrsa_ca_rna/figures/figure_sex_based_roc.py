"""This file explores sex-based determinants of MRSA data through ROC curves across gene tiers."""
...
def plot_roc_for_tier(ax, data, gene_list, tier_name):
    ...
    ax.set_title(f"ROC Curves by Class - {tier_name} ({len(X.columns)} genes)"
